# ----------------------------------------------------------------------------------------- #
# ----- Script para abrir Stroop de reward - Carpeta: Stroop-Chile2013 - grupo NIH 21y ---- #
...
setwd(stroop.dir)
archivos <- dir()
archivos <- archivos[grep("RewardsStroop", archivos)]
...
# Y se guarda
setwd(maindir)
saveWorkbook(excel, "Stroop-Chile2013 NIH 21y stats.xlsx", overwrite = TRUE)
