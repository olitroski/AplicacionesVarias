# ------------------------------------------------------------------------------------- #
# ----- Script para comprobar Stroop Alimento NIH 21y en todas sus versiones ---------- #
# ----- se revisan que los archivos sean básicamente los mismos. Usando el hash ------- #
# ----- en cuarentena 29.04.2020, Oliver Rojas, Lab.Sueño - INTA - U.Chile ------------ # 
# ------------------------------------------------------------------------------------- #
...
maindir <- "C:/Users/olitr/Desktop/Stroop 20 años/Stroop Alimento/NIH"
setwd(maindir)
...
# Ahora comparar, para eso hago un merge con la funcion omerge
# De momento está acá en githubn, en el futuro tendrá su propio package 'cuando ordene'
