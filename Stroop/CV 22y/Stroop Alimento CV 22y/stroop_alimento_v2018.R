...
# maindir = choose.dir()
maindir <- "D:/OneDrive/INTA/AplicacionesVarias/Stroop/CV 22y/Stroop Alimento CV 22y"
filedir <- "D:/OneDrive/INTA/AplicacionesVarias/Stroop/CV 22y/Stroop Alimento CV 22y/Stroop CV 22y Alimento Oliver"
setwd(filedir)
...
for (file in archivos){
    ...
    # Si hubieran colados de gonogo
    go <- FALSE
    if (length(data$press) > 0){
...
saveWorkbook(excel, "stats_stroop.alimento_CV22y.xlsx", overwrite = TRUE)
